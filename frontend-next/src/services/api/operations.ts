...
export const inventoryApi = {
  ...
  async create(data: { name: string; quantity?: number; minQuantity?: number; unitPrice: number; sku?: string; supplier?: string }) { return api.post<ApiResponse & { product: InventoryItem }>('/api/inventory/products', data); },
